...
// Package mock_cobraUtils is a generated GoMock package.
package mock_cobraUtils
...
func (m *MockPromter) Text(label string, options ...cobraUtils.PromterOptions) (string, error) {
	m.ctrl.T.Helper()
...
func (m *MockPromter) OptionalText(label string, options ...cobraUtils.PromterOptions) (string, error) {
	m.ctrl.T.Helper()
	varargs := []interface{}{label}
	for _, a := range options {
		varargs = append(varargs, a)
...
func (m *MockPromter) URLWithDefault(label, defaultValue string, options ...cobraUtils.PromterOptions) (string, error) {
	m.ctrl.T.Helper()
...
func (m *MockPromter) URL(label string, options ...cobraUtils.PromterOptions) (string, error) {
	m.ctrl.T.Helper()
	varargs := []interface{}{label}
	for _, a := range options {
		varargs = append(varargs, a)
